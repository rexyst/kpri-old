...
if(isset($_GET['nip'])){
    $sql = "SELECT 
    akun.nip, akun.nama, akun.tempat_lahir, akun.tanggal_lahir, akun.alamat_rumah, akun.kode_pos, akun.nomor_hp, akun.status, akun.level, instansi.nama_instansi, instansi.alamat_instansi 
